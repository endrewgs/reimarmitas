  ...
  return <section className="relative min-h-screen flex items-center pt-32 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          {/* Logo Badge - sem animação de flutuar, apenas transição suave */}
          <div className="mb-6 animate-fade-in-up">
            <img src={logo} alt="Rei das Marmitas Express" className="w-24 h-24 mt-10 md:mt-0 md:w-40 md:h-40 object-contain rounded-full shadow-glow border-4 border-secondary transition-transform duration-300 hover:scale-105" />
          </div>
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-xl animate-fade-in-up animation-delay-200">A melhor marmita de curitiba 😋! Amor é o principal ingrediente da nossa cozinha ❤</p>
          ...
          {/* Features */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in-up animation-delay-400">
            <div className="flex items-center gap-3 bg-card/10 backdrop-blur-sm rounded-xl p-4 transition-transform duration-300 hover:scale-[1.02]">
